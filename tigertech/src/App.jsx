...
const ContentArea = ({ activePage }) => {
  return (
    <main className="[grid-area:content] p-8 overflow-y-auto bg-neutral-100">
      ...
      {activePage === 'Attendance' && <AttendanceContent />} {/* <-- Added */}
      {activePage === 'Payroll' && <PayrollContent />}     {/* <-- Added */}
...
const MainApp = ({ onLogout, username }) => { // <-- Receive username prop
...
export default function App() {
  ...
  return (
    <div className="App">
      {isAuthenticated ? (
        <MainApp onLogout={handleLogout} username={currentUser} />
      ) : (
